...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        params = self.params
        training_data = os.path.join(self.config.data_ingestion.unzip_dir, "dataset_ct_scan")
        create_directories([
    ...
    def get_evaluation_config(self) -> EvaluationConfig:
        ...
        dagshub_repo_owner="samad-mehndi",
        dagshub_repo_name="Kidney-Disease-Classification-Project"
    )
        return eval_config